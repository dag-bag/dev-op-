        ...
        <ul className="sm:flex items-center hidden space-x-8 lg:flex">
          {session && (
            <div className="flex justify-center items-center relative">
              ...
              >
                <Image
                  className="md:text-3xl cursor-pointer text-3xl rounded-full "
        ...
        "
          ...
          {!session && (
            <Link href={"/login"}>
              <li className="cursor-pointer">
                <a
                  className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-widetransition duration-200 rounded shadow-md bg-blue-500 text-white hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                  aria-label="Sign up"
                  title="Sign up"
                >
                  Login
